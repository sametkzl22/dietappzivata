...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-slate-900 dark:via-slate-950 dark:to-teal-950 pt-20 pb-32">
        {/* Background decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-emerald-200 dark:bg-emerald-900/20 rounded-full opacity-20 blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-teal-200 dark:bg-teal-900/20 rounded-full opacity-20 blur-3xl" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 text-sm font-medium mb-6 backdrop-blur-sm">
              <Sparkles className="h-4 w-4" />
              AI-Powered Personalization
            </div>

            {/* Headline */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 dark:text-white tracking-tight leading-tight">
              Your Personal
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="#features"
                className="flex items-center gap-2 px-8 py-4 rounded-2xl border-2 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-semibold text-lg hover:border-emerald-300 dark:hover:border-emerald-700 hover:text-emerald-600 dark:hover:text-emerald-400 transition-all bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm"
              >
                See How It Works
              </Link>
            </div>
            ...
            {/* Social Proof */}
            <div className="mt-12 flex items-center justify-center gap-8 text-slate-500 dark:text-slate-400">
      ...
      <section id="features" className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white">Everything You Need</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border border-orange-100 dark:border-orange-900/30 hover:shadow-xl hover:shadow-orange-100/50 dark:hover:shadow-orange-900/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Smart Pantry</h3>
            ...
            {/* Feature 2 - AI Coach */}
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/30 dark:to-indigo-950/30 border border-purple-100 dark:border-purple-900/30 hover:shadow-xl hover:shadow-purple-100/50 dark:hover:shadow-purple-900/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">AI Coach</h3>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-100 dark:border-emerald-900/30 hover:shadow-xl hover:shadow-emerald-100/50 dark:hover:shadow-emerald-900/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Health Tracking</h3>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-slate-600 dark:text-slate-400">Three simple steps to your personalized nutrition plan</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="relative text-center">
              <div className="w-16 h-16 rounded-full bg-white dark:bg-slate-700 shadow-xl shadow-emerald-100 dark:shadow-none flex items-center justify-center mx-auto mb-6 ring-4 ring-emerald-50 dark:ring-emerald-900/30">
                <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">1</span>
              </div>
              <div className="absolute top-8 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-emerald-200 to-transparent dark:from-emerald-900/50 hidden md:block" />
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Create Your Profile</h3>
            ...
            <div className="relative text-center">
              ...
              <div className="absolute top-8 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-emerald-200 to-transparent dark:from-emerald-900/50 hidden md:block" />
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Add Your Ingredients</h3>
              <p className="text-slate-600 dark:text-slate-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Get Your Plan</h3>
              <p className="text-slate-600 dark:text-slate-400">
      ...
      {/* Final CTA Section */}
      <section className="py-24 bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-900 dark:to-teal-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Transform Your Nutrition?
          </h2>
          <p className="text-xl text-emerald-100 dark:text-emerald-200 mb-10 max-w-2xl mx-auto">
            Join thousands of users who have already improved their health with personalized AI nutrition planning.
          </p>
          <Link
            href="/register"
            className="inline-flex items-center gap-2 px-10 py-5 rounded-2xl bg-white text-emerald-600 dark:text-emerald-800 font-bold text-lg shadow-2xl hover:scale-105 transition-all"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-white">Zivata</span>
            </div>
            ...
            {/* Copyright */}
            <p className="text-sm">
              © {new Date().getFullYear()} Zivata. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
