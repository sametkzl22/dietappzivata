...
export default function ForumPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 pt-20">
            ...
            <main className="mx-auto max-w-4xl px-6 py-8 mt-16">
                {isLoading ? (
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden shadow-sm">
                            {!quickCreateExpanded ? (
                                ...
                                >
                                    ...
                                    <div className="flex-1 px-4 py-2.5 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 dark:text-slate-400">
                                ...
                                <div className="p-4 space-y-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            onClick={() => { setQuickCreateExpanded(false); setNewTitle(''); setNewContent(''); }}
